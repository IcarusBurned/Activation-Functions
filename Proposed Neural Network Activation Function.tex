...
RelU was introduced as an activation function as a replacement for the logistic function and tanh. Its formulas for ReLU and its derivative are given by $$f(x) = max(0, x)$$ $$f'(x) = \begin{cases}0 : x < 0 \\ 1 : x \geq 0 \end{cases}$$ The graphs of ReLU and its derivative are shown in Figure 2.  
